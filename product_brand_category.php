...
<div class="swiper FlagShipCategorySwiper" style="border-radius: 20px;">
  <div class="swiper-wrapper" >
     <?php
      $getCategories_new=$home_new_mod->getbrandcategory($b_id);
      foreach ($getCategories_new as $category) :
         $b64catid = base64_encode($b_id);?>
        <div class="swiper-slide">
          <div class="image-overlay" >
            <div class="overlay-text">
              <div  style="z-index: 2">
                <a   class="nav-item nav-link text-light" href="product_brand.php?cat_id=<?php echo $category['category_id'];?>&Y2F0X2lk=<?php echo $b64catid;?>&cat_name=<?php echo $category['name']?>&t=<?php echo  uniqid();?>" style="font-size: 14px;"   role="tab" data-toggle="tab"><?php echo $category['name'];?></a>
              </div>
            </div>
          </div>
        </div>            
