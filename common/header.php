...
<style>
  ...
  /*//linear-gradient(rgb(3, 26, 61), rgb(63, 28, 89), rgb(127, 0, 91), rgb(182, 0, 64), rgb(211, 0, 0));*/
        ...
        <div class="col-sm-9 col-xs-9" id="search_lbl">
          <div  class="input-group" >
            <input style=" font-size: 15px; height: 30.5px;
              ...
              type="search" id="search_val_input_h"  value="<?php if(isset($_GET['searchvalue_h'])){ echo str_replace("_20"," ",$_GET['searchvalue_h']);} ?>" placeholder="Search for product name,brand or category" class="form-control"/ autocomplete="off">
...
<div class="modal fade bd-example-modal-lg" id="LoginModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
       <div class="modal-header">
        <a type="button" id="closed_loginmod"   style="float: right;
                  font-size: 25px;
                  font-weight: 700;
                  line-height: 1;
                  color: #000;
 ...
 if($win.scrollTop() == 0) { 
  ...
  $(document).ready(function() { 
   ...
   $('#navmalls').css('display','none');
    ...
    $( "#btnlogin" ).click(function() {
      ...
      if(username == ""){
       ...
       return false;
        ...
        location.replace("ajax_loginNew.php?username=" + username  +"&password=" + password+"&t="+ new Date().getTime());
        /*$.ajax({
    ...
    $("#closed_loginmod" ).click(function() {    
          $('#LoginModal').modal('hide');
          $('#LoginModalNew').modal('show');
    });
