...
<body class="font-print" onload="window.print()">
  <div class="container">
    <div style="page-break-after: always;">
      ...
      ?>
          <div class="mt-5">
            <span style="font-size: 35px"><?php echo $o['store_name']; ?></span><span style="font-size: 25px; color:gray;"> Invoice # <?php echo $o['order_number'] ?></span>
          </div>
            ...
            <tbody>
              <tr>
                <td style="width: 50%;">
                  ...
                  <b>Website: </b> <a><?php echo $o['store_url'] ?></a>
                </td>
                <td style="width: 50%;"><b>Date Added: </b> <?php echo $o['date_added'] ?><br />
                  <b>Order ID: </b> <?php echo $o['order_number'] ?><br />
            ...
            <tbody>
              ...
              foreach ($order_product as $p) : ?>
                <tr>
                  ...
                  <td class="text-right">
                    <?php $order_product_serial = $in->order_product_serial($p['order_id'], $p['order_product_id']);
                    $serial = '';
