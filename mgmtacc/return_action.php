...
if (!strpos($perm, "'24';") !== false){
    header("Location: landing.php");
   
}


$status = new returnaction();
?>

<div id="content">

  <div class="page-header">
      <h2 class="text-center">Return Action Maintenance</h2>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading" style="padding:20px;">
        <div class="row">
          <div class="col-lg-6">
            <p style="font-weight: 700;" class="panel-title"> <i class="fa fa-list"></i>  Return Action List
            </p>
          </div>
          <div class="col-lg-6">
      ...
      <div class="panel-body">
        <div class="table-responsive">
          ...
          <td>
            <button class="btn btn-primary" data-id="<?php echo $status['return_action_id'];?>" data-name="<?php echo $status['name'];?>" id="btnedit"><i class="fa fa-edit"></i></button>
             <button class="btn btn-danger" data-id="<?php echo $status['return_action_id'];?>" id="btndelete"><i class="fa fa-ban"></i></button>
          </td>
          </tr>
 ...
 <script>
  ...
  $( document ).ready(function() {
        ...
        $('#add-brand').click(function() {
          $("#modallabel").html("Add New Action");
