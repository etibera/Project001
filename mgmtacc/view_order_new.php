    ...
    $(document).delegate('#SaveOrderHistory', 'click', function() {  
    	$('#SaveOrderHistory').prop('disabled', true);
      	...
      	if(order_status_id==47){
      		...
      		$.ajax({
	          url: 'ajax_order_history.php?action=SaveOrderHistoryPackage',
	          type: 'post',
	          data: 'seller_id=' + seller_id+'&order_id='+order_id+'&order_status_id='+order_status_id+'&comment='+comment+'&package_type='+order_package_type,
	          dataType: 'json',
	           beforeSend: function() {
		        	bootbox.dialog({
      		...
      		$.ajax({
		        ...
		        type: 'POST',
		        data: 'seller_id=' + seller_id + '&order_id='+order_id + '&comment='+comment,
		        dataType: 'json',
		         beforeSend: function() {
		        	bootbox.dialog({
				            title: "Adding Order History",
      		...
      		$.ajax({
	          url: 'ajax_order_history.php?action=SaveOrderHistory',
	          type: 'post',
	          data: 'seller_id=' + seller_id+'&order_id='+order_id+'&order_status_id='+order_status_id+'&comment='+comment,
	          dataType: 'json',
	          beforeSend: function() {
		        	bootbox.dialog({
				            title: "Adding Order History",
