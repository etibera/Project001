    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="table-responsive">
          ...
          <td>
            <button class="btn btn-primary" data-id="<?php echo $status['order_status_id'];?>" data-name="<?php echo $status['name'];?>" id="btnedit"><i class="fa fa-edit"></i></button>
             <button class="btn btn-danger" data-id="<?php echo $status['order_status_id'];?>" id="btndelete"><i class="fa fa-ban"></i></button>
          </td>
          </tr>
