...
//public $http_image = 'http://localhost/peso/';
	public $http_image = 'http://34.71.32.229/peso-web-new/'; //for test server
	...
	public function dir_image(){
		...
		return isset($_SERVER['HTTPS']) ? '/home/irpge67jnamu/public_html/img/' : '/var/www/html/peso-web-new/img/';
	}
