...
switch($source){
        ...
        case 'reply':
            if(isset($_POST['sender_id']) &&  isset($_POST['customer_id']) && isset($_POST['msg']) ){
                $data = $message->reply($_POST['sender_id'], $_POST['customer_id'], $_POST['msg'], $_POST['product_id']);
                echo json_encode($data);
            }
        break;
        case 'messageDetail':
        ...
        case 'multiReply':
            if(isset($_POST['sender_id']) &&  isset($_POST['customer_id']) && isset($_POST['msg']) ){
                $data = $message->multiReply($_POST['sender_id'], $_POST['customer_id'], $_POST['msg']);
                echo json_encode($data);
            }
        break;
        case 'getSellerMessage':
            $data = $message->getSellerMessage($_GET['customer_id']);
            echo json_encode($data);
        break;
        case 'read':
            $data = $message->read();
