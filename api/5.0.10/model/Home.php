...
class Home {
    ...
    public function most_popular(){
        ...
        $sql = "SELECT * FROM (
                                        ...
                                        UNION ALL
                                        SELECT p.product_id,pv.p_type ,pv.date_viewed,p.product_name as name,p.price,p.img as image,concat('bg_product.php?product_idbg=',p.product_id) as href,SUM(pv.total_views) as viewed 
                                        FROM product_views pv 
