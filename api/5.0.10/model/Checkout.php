...
class Checkout {
    ...
    public function SaveShippingPerStore($shipping_per_store,$order_id, $order_status_id){
        $shippingValue = array('flat.flat', 'pickup.pickup', 'shipping_fee');
        foreach($shipping_per_store as $t){
            if(in_array($t['code'], $shippingValue)){
                ...
                $addStoreOrders= $this->conn->prepare("INSERT INTO store_orders  SET order_id = :order_id, seller_id = :seller_id");
