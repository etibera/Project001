...
class Banggood {
    ...
    public function getProduct($product_id){
        ...
        $data = array(
            ...
            'newPrice' => round((float) $price_pp + $shipFee, 2),
            ...
            'storeList' => [
                    array(
                        'image' => 'https://pinoyelectronicstore.com/img/mobile/discover/peso-global.webp',
                       'shopName' => 'PESO Global',
                       'sellerId' => null,
                       'deductionData' =>  [],
                       'thumb' => 'https://pinoyelectronicstore.com/img/mobile/discover/peso-global.webp',  
                    )
                ],
        );
        if($result_gs['code'] == 0){
    ...
    public function importBGProducts($order_id, $method){
        ...
        if($method!='cod'){
            ...
            $params['delivery_street_address']  = $d_address['shipping_address_1'].' '.$d_address['shipping_address_2'].' ,'.$d_address['shipping_district'];
            $params['delivery_street_address2'] = "";
            $params['delivery_state']           = $d_address['shipping_region'];
            $params['delivery_city']            = $d_address['shipping_city'];
           ...
           $params['delivery_street_address2'] = '';
           $params['delivery_state']           = 'Metro Manila';
           $params['delivery_city']            = 'Quezon City';
