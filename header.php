...
$unreads2['unreads']=0;
$fname = isset($_SESSION['user_name']) ? $_SESSION['user_name']: "_null"; 
          ...
          <li class="dropdown" style="margin: 0 10px"  >
            ...
            <ul class="dropdown-menu dropdown-menu-center" >
              <?php if ($is_log) { ?>
                ...
                <?php }?>                 
              <?php } else { ?>
              <li><a  class="ATCenter LoginModalshow">Login</a></li>
              <?php } ?>
            </ul>
          </li>           
          <li style="margin: 0 10px">  
            ...
            <?php }else{ ?>
              <a title="Order History" class="navemenust-UL-LIdropdown-A LoginModalshow" id="LoginModalshow">    <b  class="navemenust_UL_LI_A_B">Orders</b>
              </a>
            <?php }?>     
          </li>
          <li class="dropdown" style="margin: 0 10px"> 
