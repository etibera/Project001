			...
			<div class="accordion-item">
				...
				<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordion">
					<div class="accordion-body">
						<div class="row">
							<label class="col-sm-2 form-label" for="input-voucher" style="text-align: right;">Total Amount :</label>
							<label class="col-sm-4 form-label" for="input-voucher">
								<span style="font-weight: bolder;"><?php echo number_format($total_cash_Wallet, 2); ?></span>
							</label>
						</div>
						<div class="row">
							<label class="col-sm-2 form-label" for="input-voucher" style="text-align: right;">Preferred Amount:</label>
							<div class="col-sm-4 input-group">
								<input type="number" name="CASHwallet" value="<?php echo $digitalwallet_cash_val; ?>" placeholder="Input your Preferred Amount" class="form-control me-3" />
								<span class="input-group-btn">
									<?php if ($digitalwallet_cash_val == 0) { ?>
										<a id="button-wallet_CASH" class="btn btn-primary" data-toggle="tooltip" title="Apply"><i class="far fa-save"></i></a>
									<?php } else { ?>
										<a id="button-wallet_CASH-cancel" class="btn btn-danger" data-toggle="tooltip" title="Cancel"><i class="fas fa-times"></i></a>
									<?php } ?>
								</span>
							</div>
						</div>
				...
				<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordion">
					<div class="accordion-body">
						...
						<div class="row">
							<label class="col-sm-2 form-label" for="input-voucher" style="text-align: right;">Preferred Amount:</label>
							<div class="col-sm-4 input-group">
								<input type="number" name="digitalwallet" value="<?php echo $digitalwalletr_val; ?>" placeholder="Input your Preferred Amount" class="form-control me-3" />
								<span class="input-group-btn">
									<?php if ($digitalwalletr_val == 0) { ?>
										<a id="button-wallet" class="btn btn-primary" data-toggle="tooltip" title="Apply"><i class="far fa-save"></i></a>
									<?php } else { ?>
										<a id="button-wallet_cancel" class="btn btn-danger" data-toggle="tooltip" title="Cancel"><i class="fas fa-times"></i></a>
									<?php } ?>
								</span>
							</div>
						</div>
						<div class="row">
							<label class="col-sm-12 form-label text-danger" for="input-voucher" style="text-align: left;">*Note: Discount wallet must not exceed 50% of the total purchase amount.</label>
						</div>
					</div>
				</div>
			</div>
