 <style type="text/css">
  ...
  <section class="center-pr slider-pr">
    <?php foreach ($recommended_product as $products_rec) : ?>
      <?php if($products_rec['type']=='0'){ ?> 
          ...
          <div class="card-pr" >
            <div class="">
              ...
              <?php $name = strlen($productdesc_rec['name']) > 25 ? substr($productdesc_rec['name'],0,25)."..." : $productdesc_rec['name'];?>
                ...
                <p  style="color:#e81b30; font-size: 12px"><b>₱<?php echo   number_format($productdesc_rec['price'],2);?></b></p>
                </p>
              </div> 
        ...
        <?php }else if($products_rec['type']=='2'){ ?> 
          <?php $productdesc_rec = $model_home->getproduct_bg($products_rec['product_id']);?>
