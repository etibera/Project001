...
$customerActivity->insertactivity($userid, 'Discount Wallet');
...
<div class="container bg-white p-sm-3" style="margin-top: 135px">
  <div id="content">
    <div class="row">
      <div class="col-12">
        <span style="font-size: 26px">Discount Wallet</span>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
        <div class="table-responsive">
          <table class="table table-bordered table-hover" id="table">
            <tbody>
              <?php
              $total = 0;
              foreach ($discount_wallet->getdiscountwallet($id) as $dwallet1) {
              ...
              <?php foreach ($discount_wallet->getdiscountwallet($id) as $dwallet) { ?>
                <tr>
